...
best_model_path_waveform_machine = 'cat_emb/result/tas_5/best_model_w.pt'
best_model_path_spectrogram_machine = 'cat_emb/result/tas_5/best_model_s.pt'
best_model_path_compressor_machine = 'cat_emb/result/tas_5/best_model_c.pt'
...
with open('cat_emb/result_emb/train_att_emb.pickle', 'wb') as f:
...
with open('cat_emb/result_emb/test_att_emb.pickle', 'wb') as f:
...
with open('cat_emb/result_emb/eval_att_emb.pickle', 'wb') as f:
